...
class PartiesViewController: UIViewController, PartiesTableViewControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.leftBarButtonItem = UIBarButtonItem(title: "Map", style: .plain, target: self, action: #selector(showLMG))
    }
    
    @objc func showLMG() {
        let controller = LMGMapWireframe.mapViewController()
